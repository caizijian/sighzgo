    ...
    public partial class edit : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //给按钮附加对应确认弹窗
                //CZJ 392067117@qq.com 2017/08/22
                head.ImageUrl = "../../img/head/" + Session["uid"] + ".jpg";
            ...
            if (checknull())
            {
               ...
               int flag= temp.saveedit(menagername.Text.Trim(),companyname.Text.Trim(),mainbusiness.Text.Trim(),wechat.Text.Trim(),telephone.Text.Trim(),(int)Session["uid"]);
                ...
                if (flag == 1)
                {
                    ...
                    Response.Redirect("readonly_host.aspx", false);
                }
                else
        ...
        protected void update_Click(object sender, EventArgs e)
        {
            ...
            {
                string SavePath = Server.MapPath("../../img/user/host/");     //设置保存路径
