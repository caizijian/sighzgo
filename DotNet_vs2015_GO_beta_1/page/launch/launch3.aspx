...
<asp:ListItem Value="2">团队赛</asp:ListItem>
                                ...
                                <asp:Panel ID="Panel1" runat="server" Width="238px" Visible="False" Height="41px"> 每组： <asp:TextBox ID="minmember" runat="server"  Width="34px" onkeypress="if (event.keyCode < 48 || event.keyCode >57) event.returnValue = false;" Height="20px" TextMode="Number" ></asp:TextBox>
                                &nbsp;— <asp:TextBox ID="maxmember" runat="server" Width="32px" onkeypress="if (event.keyCode < 48 || event.keyCode >57) event.returnValue = false;" Height="20px"  TextMode="Number"></asp:TextBox>
&nbsp;人</asp:Panel>
...
&nbsp;<br />
                        ...
                        <tr>
                            <td class="auto-style13">
                                ...
                                比赛起止时间：</td>
                            <td>
                                <asp:TextBox ID="starttime" runat="server" Height="19px" Width="143px" placeholder="yyyy/mm/dd-hh:mm"  onfocus="WdatePicker({dateFmt:'yyyy/MM/dd HH:mm'})"></asp:TextBox>
                            &nbsp;
                                <asp:TextBox ID="endtime" runat="server" Height="19px" Width="143px" placeholder="yyyy/mm/dd-hh:mm" onfocus="WdatePicker({dateFmt:'yyyy/MM/dd HH:mm'})"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style13">
                                ...
                                最高奖金：</td>
                            <td>
                                <asp:TextBox ID="maxbouns" runat="server" Height="19px" Width="100px" placeholder="格式如10000"  MaxLength="8"  TextMode="Number"></asp:TextBox>
&nbsp;元&nbsp;&nbsp; 
